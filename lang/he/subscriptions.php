...
return [
    ...
    'suggest_products' => 'הצע מוצרים מתאימים',
    'suggest_products_help' => 'מוסיף לרשימה את הווריאנטים שהמנוע ממליץ עליהם לכלב הזה — לפי משקל, גיל ורגישויות. מה שכבר נבחר נשאר.',
    'suggest_added' => 'נוספו :count מוצרים מתאימים',
