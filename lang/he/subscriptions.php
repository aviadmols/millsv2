...
return [
    ...
    'preview_stale' => 'הסכום השמור לחיוב הוא :stored, אבל לפי המוצרים והכללים הנוכחיים הוא אמור להיות :computed. הסכום השמור ישן — לחץ "רענן הזמנה קרובה" לפני החיוב הבא.',
