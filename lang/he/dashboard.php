...
return [
    ...
    'missing_orders_resolve' => 'סידרתי',
    'missing_orders_resolve_heading' => 'סימון כמטופל',
    'missing_orders_resolve_help' => 'הלקוח יורד מההתראה בדף הבית. החיוב עצמו לא משתנה — לא מחויב שוב ולא מוחזר. הסימון, מי סימן ומתי יירשמו בטיים-ליין של המנוי.',
    'missing_orders_resolve_submit' => 'סמן כמטופל והסר מההתראה',
    'missing_orders_resolve_order' => 'קישור להזמנה שיצרת ידנית (אופציונלי)',
    'missing_orders_resolve_order_help' => 'אם יצרת את ההזמנה בשופיפיי בעצמך — הדבק כאן את הכתובת של דף ההזמנה. היא תקושר לחיוב ותופיע בהיסטוריית החיובים של המנוי.',
    'missing_orders_resolve_order_invalid' => 'לא זוהתה הזמנה. הדבק את כתובת דף ההזמנה בשופיפיי (…/orders/19030456926512) — מספר הזמנה כמו #74500 לא מספיק.',
    'missing_orders_resolve_note' => 'איך זה טופל (אופציונלי)',
    'missing_orders_resolve_note_placeholder' => 'למשל: נוצרה הזמנה ידנית, או: הכסף הוחזר ללקוח',
    'missing_orders_resolved' => 'סומן כמטופל והוסר מההתראה',
    'missing_orders_resolved_timeline' => 'החיוב של :amount מ-:date ללא הזמנה סומן כמטופל',
    'missing_orders_resolved_linked' => 'קושר להזמנה :id',
    'missing_orders_all_resolved' => 'כל המקרים טופלו.',
