...
return [
    ...
    'missing_orders_heading' => 'חויבו ולא נוצרה להם הזמנה',
    'missing_orders_description' => 'הלקוחות האלה שילמו, אבל ההזמנה בשופיפיי לא נוצרה — ולכן שום דבר לא יישלח אליהם. הכסף לא הוחזר ולא ייגבה שוב. ליד כל אחד מופיעה הסיבה כפי ששופיפיי ניסח אותה. תקן את הסיבה ואז צור את ההזמנה.',
