...
return [
    ...
    'missing_orders_resolve' => 'Resolved',
    'missing_orders_resolve_heading' => 'Mark as resolved',
    'missing_orders_resolve_help' => 'The customer leaves the home-screen alert. The charge itself does not change — nothing is charged again or refunded. The resolution, who marked it and when, is written to the subscription timeline.',
    'missing_orders_resolve_submit' => 'Mark resolved and remove from the alert',
    'missing_orders_resolve_order' => 'Link to the order you created by hand (optional)',
    'missing_orders_resolve_order_help' => 'If you created the order in Shopify yourself, paste the address of its order page. It is linked to the charge and shows in the subscription\'s billing history.',
    'missing_orders_resolve_order_invalid' => 'No order recognised. Paste the address of the order page in Shopify (…/orders/19030456926512) — an order number such as #74500 is not enough.',
    'missing_orders_resolve_note' => 'How it was handled (optional)',
    'missing_orders_resolve_note_placeholder' => 'e.g. order created by hand, or: the money was refunded',
    'missing_orders_resolved' => 'Marked resolved and removed from the alert',
    'missing_orders_resolved_timeline' => 'The :amount charge from :date with no order was marked resolved',
    'missing_orders_resolved_linked' => 'linked to order :id',
    'missing_orders_all_resolved' => 'Every case has been handled.',
